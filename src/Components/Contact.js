...
const Contact = () => {
  ...
  const Submit = async (e) => {
    ...
    const response = fetch(
      "https://armaan-b8d4a-default-rtdb.firebaseio.com/data.json",
      {
        method: "POST",
        headers: {
  ...
  return (
    <div>
      <form
        method="post"
        onSubmit={Submit}
        action="https://miniproject-photo-gallary-default-rtdb.firebaseio.com/userdata"
      >
        <div className="first ">
          <div className="second">
            ...
            <div className="form d-flex flex-wrap border-rounder">
              <div className="name namescon fs-2 ">
                Name{" "}
                <ContactPageIcon style={{ color: "white", fontSize: "35px" }} />
                <input
                  value={Data.fname}
                  onChange={Postdata}
              ...
              <div className="email namescon namescon fs-2 ">
                Email:
                <MailIcon style={{ color: "white", fontSize: "35px" }} />
                <input
                  value={Data.email}
                  onChange={Postdata}
              ...
              <div className="name namescon fs-2 ">
                ...
                <textarea
                  value={Data.Message}
                  onChange={Postdata}
                  className="   bg-white namescon a1234 "
                  type="text"
                  name="Message"
                  row="20"
                  cols="20"
                ...
                Submit <SendIcon style={{ color: "white", fontSize: "45px" }} />
              </div>
            </div>
          </div>
        </div>
