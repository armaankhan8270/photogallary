...
const Rec = () => {
  ...
  return (
    <div className="bg-white ">
      <div className="flex">
        <input
          className="w-full shadow-md rounded-sm m-3 font-mono font-bold focus:outline-none bg-white p-2 "
          type="text"
          placeholder="serach"
          name="psw"
          value={search}
      ...
      <div className="flex  flex-wrap ml-44">
        {recipies.map((recipe) => {
          return (
            <div className="bg-white justify-center w-[33%] m-4">
              <div class="w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
                <img
                  class="  border w-full shadow-md rounded max-w-sm"
                  alt="avatar"
                ...
                <div class="flex items-center px-6 py-3 bg-gray-900">
                  ...
                  <h1 class="mx-3 text-lg font-mono font-semibold text-white">
                    {recipe.recipe.label}
                  </h1>
                </div>
                ...
                <div class="px-6 py-4">
                  ...
                  <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                    ...
                    <h1 class="px-2 text-sm">{recipe.recipe.dishType}</h1>
                  </div>
                  ...
                  <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                    ...
                    <h1 class="px-2 text-sm">{recipe.recipe.cuisineType}</h1>
                  </div>
